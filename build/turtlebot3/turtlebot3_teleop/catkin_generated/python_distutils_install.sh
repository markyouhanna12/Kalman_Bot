...
echo_and_run cd "/home/vboxuser/catkin_workspace/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/vboxuser/catkin_workspace/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/vboxuser/catkin_workspace/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
