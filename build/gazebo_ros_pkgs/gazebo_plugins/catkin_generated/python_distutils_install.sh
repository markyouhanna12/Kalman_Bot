...
echo_and_run cd "/home/vboxuser/catkin_workspace/src/gazebo_ros_pkgs/gazebo_plugins"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/vboxuser/catkin_workspace/src/gazebo_ros_pkgs/gazebo_plugins/setup.py" \
     \
    build --build-base "/home/vboxuser/catkin_workspace/build/gazebo_ros_pkgs/gazebo_plugins" \
    install \
    --root="${DESTDIR-/}" \
